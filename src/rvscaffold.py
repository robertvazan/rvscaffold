...
class Java(Repository):
    ...
    use_pmsite = define_use('com.machinezoo.pmsite:pmsite:0.18.8')
    use_ladybugformatters = define_use('com.machinezoo.ladybugformatters:ladybugformatters:0.1.2')
    ...
    use_foxcache = define_use('com.machinezoo.foxcache:foxcache:0.1.6')
