...
use_stagean = define_use('com.machinezoo.stagean:stagean:1.2.0')
use_noexception = define_use('com.machinezoo.noexception:noexception:1.7.1')
...
use_pmsite = define_use('com.machinezoo.pmsite:pmsite:0.18.2')
